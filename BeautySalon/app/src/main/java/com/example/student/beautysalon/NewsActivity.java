    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(){
            ...
            public void run()
            {
                URL url = null;
                try {
                    url = new URL("https://style.udn.com/rss/news/2002/8054/8079?ch=style");
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            adapter = new ArrayAdapter<String>(NewsActivity.this, android.R.layout.simple_list_item_1, forAdapter);
                            lv.setAdapter(adapter);
                            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                @Override
                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                    Intent it = new Intent( NewsActivity.this,NewsDetail.class);
